          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-8 border border-gray-200 rounded-3xl bg-white">
              ...
              <ul className="space-y-3 mb-8">
                {['PDV completo', 'Até 100 produtos', 'Relatórios básicos', 'Suporte por email'].map(f => (
              ...
              <button
                onClick={() => { setFormData({ ...formData, plano: 'gratis' }); setStep('form'); }}
            ...
            <div className="p-8 border-2 border-emerald-500 rounded-3xl bg-white relative">
              ...
              <button
                onClick={() => { setFormData({ ...formData, plano: 'mensal' }); setStep('form'); }}
            ...
            <div className="p-8 border border-gray-200 rounded-3xl bg-white">
              ...
              <button
                onClick={() => { setFormData({ ...formData, plano: 'anual' }); setStep('form'); }}
